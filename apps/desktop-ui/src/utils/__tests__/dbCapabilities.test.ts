...
describe('database metadata capabilities', () => {
  ...
  it('keeps TDengine browsing and time-series metadata read-only', () => {
    ...
    expect(capabilities.metadata.pagedObjects).toBe(true)
    ...
    expect(capabilities.workbench.timeSeriesQuery).toBe(true)
    expect(capabilities.workbench.timeSeriesLoadedDataExport).toBe(true)
    expect(capabilities.workbench.timeSeriesLifecycle).toBe(true)
    expect(capabilities.workbench.timeSeriesObjectDelete).toBe(true)
    expect(capabilities.workbench.timeSeriesBasicTableLifecycle).toBe(true)
    expect(capabilities.workbench.timeSeriesDataWrite).toBe(true)
    expect(capabilities.workbench.timeSeriesCsvImport).toBe(true)
    expect(capabilities.workbench.exportData).toBe(false)
  ...
  it('keeps time-series lifecycle editing disabled for relational databases', () => {
    expect(getDbCapabilities('mysql').workbench.timeSeriesLifecycle).toBe(false)
    expect(getDbCapabilities('dameng').workbench.timeSeriesLifecycle).toBe(false)
    expect(getDbCapabilities('mysql').workbench.timeSeriesObjectDelete).toBe(false)
    expect(getDbCapabilities('dameng').workbench.timeSeriesObjectDelete).toBe(false)
    expect(getDbCapabilities('mysql').workbench.timeSeriesBasicTableLifecycle).toBe(false)
    expect(getDbCapabilities('dameng').workbench.timeSeriesDataWrite).toBe(false)
    expect(getDbCapabilities('mysql').workbench.timeSeriesCsvImport).toBe(false)
    expect(getDbCapabilities('dameng').workbench.timeSeriesCsvImport).toBe(false)
  })
})
